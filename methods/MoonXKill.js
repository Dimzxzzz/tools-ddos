 ...
 if (process.argv.length < 5){console.log(`usage: node MoonXkill.js <target> <time> <rate> <therds>`); process.exit();}
 ...
 if (cluster.isMaster) {
    ...
    console.log('[ ! ] Rate: ' + args.Rate + '\x1b[0m');
